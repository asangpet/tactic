...
ssh root@amdw6 /opt/ccapper -s 10.0.70.1 10.0.80.1 10.0.91.1 10.0.90.1 10.0.60.1 10.0.60.2 &
ssh root@amdw7 /opt/ccapper -s 10.0.60.3 10.0.60.4 10.0.60.5 10.0.50.1 &
sleep 10
echo "Running test"
