...
# For multi_app12_sm345
#ssh root@amdw6 /opt/ccapper -s 10.0.50.1 10.0.60.1 10.0.60.2 10.0.91.1 10.0.70.1 &
#ssh root@amdw7 /opt/ccapper -s 10.0.80.1 10.0.60.3 10.0.60.4 10.0.60.5 10.0.90.1 &

# For multi_app12_sn345
#ssh root@amdw6 /opt/ccapper -s 10.0.50.1 10.0.60.1 10.0.60.2 10.0.90.1 10.0.70.1 &
#ssh root@amdw7 /opt/ccapper -s 10.0.80.1 10.0.60.3 10.0.60.4 10.0.60.5 10.0.91.1 &

# For multi_vdns_12345m
#ssh root@amdw6 /opt/ccapper -s 10.0.50.1 10.0.70.1 10.0.80.1 10.0.91.1 &
#ssh root@amdw7 /opt/ccapper -s 10.0.90.1 10.0.60.1 10.0.60.2 10.0.60.3 10.0.60.4 10.0.60.5 &

# For multi_vdns12_345m
#ssh root@amdw6 /opt/ccapper -s 10.0.50.1 10.0.70.1 10.0.80.1 10.0.91.1 10.0.60.1 10.0.60.2 &
#ssh root@amdw7 /opt/ccapper -s 10.0.90.1 10.0.60.3 10.0.60.4 10.0.60.5 &

# For multi_vdns1_2345m
#ssh root@amdw6 /opt/ccapper -s 10.0.50.1 10.0.70.1 10.0.80.1 10.0.91.1 10.0.60.1 &
#ssh root@amdw7 /opt/ccapper -s 10.0.90.1 10.0.60.2 10.0.60.3 10.0.60.4 10.0.60.5 &

# For multi_vdnsm1_2345
#ssh root@amdw6 /opt/ccapper -s 10.0.50.1 10.0.70.1 10.0.80.1 10.0.91.1 10.0.60.1 10.0.90.1 &
#ssh root@amdw7 /opt/ccapper -s 10.0.60.2 10.0.60.3 10.0.60.4 10.0.60.5 &

# For multi_vdms1_2345n
ssh root@amdw6 /opt/ccapper -s 10.0.50.1 10.0.70.1 10.0.80.1 10.0.60.1 10.0.90.1 &
ssh root@amdw7 /opt/ccapper -s 10.0.60.2 10.0.60.3 10.0.60.4 10.0.60.5 10.0.91.1 &
